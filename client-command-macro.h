...
#ifndef __CLUSTER_CLIENT_API__
#define __CLUSTER_CLIENT_API__
...
/** @name Lumi Device optional Commands */
// @{
/** @} END Lumi Device optional Commands */


/** @name IR Repeater Commands */
// @{
/** @brief HC send this command to require IR controller Learn new IR command
 *
 * Cluster: IR Repeater, This cluster used for LM_IR, a IR repeater device.
 * Command: LearnNewIrCmd
 */
#define emberAfFillCommandIrRepeaterClusterLearnNewIrCmd() \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_IR_REPEATER_CLUSTER_ID, \
                                                0x1002, \
                                                ZCL_LEARN_NEW_IR_CMD_COMMAND_ID, \
                                                "");


/** @brief HC send this command to require controller Stop learn current IR command
 *
 * Cluster: IR Repeater, This cluster used for LM_IR, a IR repeater device.
 * Command: StopLearnIrCmd
 */
#define emberAfFillCommandIrRepeaterClusterStopLearnIrCmd() \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_IR_REPEATER_CLUSTER_ID, \
                                                0x1002, \
                                                ZCL_STOP_LEARN_IR_CMD_COMMAND_ID, \
                                                "");


/** @brief HC send this command to require controller Active specific IR command
 *
 * Cluster: IR Repeater, This cluster used for LM_IR, a IR repeater device.
 * Command: ActiveIrCmd
 * @param ICommandID uint16_t
 */
#define emberAfFillCommandIrRepeaterClusterActiveIrCmd(ICommandID) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_IR_REPEATER_CLUSTER_ID, \
                                                0x1002, \
                                                ZCL_ACTIVE_IR_CMD_COMMAND_ID, \
                                                "v", \
                                                ICommandID);


/** @brief HC send this command to require controller Delete specific IR command
 *
 * Cluster: IR Repeater, This cluster used for LM_IR, a IR repeater device.
 * Command: DeleteIrCmd
 * @param IRCommandID uint16_t
 */
#define emberAfFillCommandIrRepeaterClusterDeleteIrCmd(IRCommandID) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_IR_REPEATER_CLUSTER_ID, \
                                                0x1002, \
                                                ZCL_DELETE_IR_CMD_COMMAND_ID, \
                                                "v", \
                                                IRCommandID);


/** @brief HC send this command to check current state of IR controller
 *
 * Cluster: IR Repeater, This cluster used for LM_IR, a IR repeater device.
 * Command: CheckIrState
 */
#define emberAfFillCommandIrRepeaterClusterCheckIrState() \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_CLIENT_TO_SERVER), \
                                                ZCL_IR_REPEATER_CLUSTER_ID, \
                                                0x1002, \
                                                ZCL_CHECK_IR_STATE_COMMAND_ID, \
                                                "");


/** @brief IR device send this command to HC to update current IR controller state
 *
 * Cluster: IR Repeater, This cluster used for LM_IR, a IR repeater device.
 * Command: UpdateIrState
 * @param State uint8_t
 * @param IRCommandID uint16_t
 */
#define emberAfFillCommandIrRepeaterClusterUpdateIrState(State, \
                                                         IRCommandID) \
  emberAfFillExternalManufacturerSpecificBuffer((ZCL_CLUSTER_SPECIFIC_COMMAND \
                                                 | ZCL_MANUFACTURER_SPECIFIC_MASK \
                                                 | ZCL_FRAME_CONTROL_SERVER_TO_CLIENT), \
                                                ZCL_IR_REPEATER_CLUSTER_ID, \
                                                0x1002, \
                                                ZCL_UPDATE_IR_STATE_COMMAND_ID, \
                                                "uv", \
                                                State, \
                                                IRCommandID);


/** @} END IR Repeater Commands */
