 ...
 * This callback would be implemented in idle/sleep
            plugin by the
 * name emberAfCamBackFromEM4Callback and
...
/** @name Lumi Device optional Cluster Callbacks */
// @{

/** @brief Lumi Device optional Cluster Client Attribute Changed
 *
 * Client Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfLmDevOptClientAttributeChangedCallback(uint8_t endpoint,
                                                   EmberAfAttributeId attributeId);
/** @brief Lumi Device optional Cluster Client Default Response
 *
 * This function is called when the client receives the default response from
 * the server.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfLmDevOptClientDefaultResponseCallback(uint8_t endpoint,
                                                  uint8_t commandId,
                                                  EmberAfStatus status);
/** @brief Lumi Device optional Cluster Client Init
 *
 * Client Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfLmDevOptClientInitCallback(uint8_t endpoint);
/** @brief Lumi Device optional Cluster Client Manufacturer Specific Attribute Changed
 *
 * Client Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfLmDevOptClientManufacturerSpecificAttributeChangedCallback(uint8_t endpoint,
                                                                       EmberAfAttributeId attributeId,
                                                                       uint16_t manufacturerCode);
/** @brief Lumi Device optional Cluster Client Message Sent
 *
 * Client Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfLmDevOptClientMessageSentCallback(EmberOutgoingMessageType type,
                                              uint16_t indexOrDestination,
                                              EmberApsFrame *apsFrame,
                                              uint16_t msgLen,
                                              uint8_t *message,
                                              EmberStatus status);
/** @brief Lumi Device optional Cluster Client Pre Attribute Changed
 *
 * Client Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfLmDevOptClientPreAttributeChangedCallback(uint8_t endpoint,
                                                               EmberAfAttributeId attributeId,
                                                               EmberAfAttributeType attributeType,
                                                               uint8_t size,
                                                               uint8_t *value);
/** @brief Lumi Device optional Cluster Client Tick
 *
 * Client Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfLmDevOptClientTickCallback(uint8_t endpoint);
/** @brief Lumi Device optional Cluster Server Attribute Changed
 *
 * Server Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
...
void emberAfLmDevOptServerAttributeChangedCallback(uint8_t endpoint,
                                                   EmberAfAttributeId attributeId);
/** @brief Lumi Device optional Cluster Server Default Response
 *
 * This function is called when the server receives the default response from
 * the client.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfLmDevOptServerDefaultResponseCallback(uint8_t endpoint,
                                                  uint8_t commandId,
                                                  EmberAfStatus status);
/** @brief Lumi Device optional Cluster Server Init
 *
 * Server Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfLmDevOptServerInitCallback(uint8_t endpoint);
/** @brief Lumi Device optional Cluster Server Manufacturer Specific Attribute Changed
 *
 * Server Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfLmDevOptServerManufacturerSpecificAttributeChangedCallback(uint8_t endpoint,
                                                                       EmberAfAttributeId attributeId,
                                                                       uint16_t manufacturerCode);
/** @brief Lumi Device optional Cluster Server Message Sent
 *
 * Server Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfLmDevOptServerMessageSentCallback(EmberOutgoingMessageType type,
                                              uint16_t indexOrDestination,
                                              EmberApsFrame *apsFrame,
                                              uint16_t msgLen,
                                              uint8_t *message,
                                              EmberStatus status);
/** @brief Lumi Device optional Cluster Server Pre Attribute Changed
 *
 * Server Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfLmDevOptServerPreAttributeChangedCallback(uint8_t endpoint,
                                                               EmberAfAttributeId attributeId,
                                                               EmberAfAttributeType attributeType,
                                                               uint8_t size,
                                                               uint8_t *value);
/** @brief Lumi Device optional Cluster Server Tick
 *
 * Server Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfLmDevOptServerTickCallback(uint8_t endpoint);

/** @} END Lumi Device optional Cluster Callbacks */

/** @name IR Repeater Cluster Callbacks */
// @{

/** @brief IR Repeater Cluster Active Ir Cmd
 *
 * 
 *
 * @param ICommandID   Ver.: always
 */
bool emberAfIrRepeaterClusterActiveIrCmdCallback(uint16_t ICommandID);
/** @brief IR Repeater Cluster Check Ir State
 *
 * 
 *
 */
bool emberAfIrRepeaterClusterCheckIrStateCallback(void);
/** @brief IR Repeater Cluster Client Attribute Changed
 *
 * Client Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfIrRepeaterClusterClientAttributeChangedCallback(uint8_t endpoint,
                                                            EmberAfAttributeId attributeId);
/** @brief IR Repeater Cluster Client Default Response
 *
 * This function is called when the client receives the default response from
 * the server.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfIrRepeaterClusterClientDefaultResponseCallback(uint8_t endpoint,
                                                           uint8_t commandId,
                                                           EmberAfStatus status);
/** @brief IR Repeater Cluster Client Init
 *
 * Client Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfIrRepeaterClusterClientInitCallback(uint8_t endpoint);
/** @brief IR Repeater Cluster Client Manufacturer Specific Attribute Changed
 *
 * Client Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfIrRepeaterClusterClientManufacturerSpecificAttributeChangedCallback(uint8_t endpoint,
                                                                                EmberAfAttributeId attributeId,
                                                                                uint16_t manufacturerCode);
/** @brief IR Repeater Cluster Client Message Sent
 *
 * Client Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfIrRepeaterClusterClientMessageSentCallback(EmberOutgoingMessageType type,
                                                       uint16_t indexOrDestination,
                                                       EmberApsFrame *apsFrame,
                                                       uint16_t msgLen,
                                                       uint8_t *message,
                                                       EmberStatus status);
/** @brief IR Repeater Cluster Client Pre Attribute Changed
 *
 * Client Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfIrRepeaterClusterClientPreAttributeChangedCallback(uint8_t endpoint,
                                                                        EmberAfAttributeId attributeId,
                                                                        EmberAfAttributeType attributeType,
                                                                        uint8_t size,
                                                                        uint8_t *value);
/** @brief IR Repeater Cluster Client Tick
 *
 * Client Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfIrRepeaterClusterClientTickCallback(uint8_t endpoint);
/** @brief IR Repeater Cluster Delete Ir Cmd
 *
 * 
 *
 * @param IRCommandID   Ver.: always
 */
bool emberAfIrRepeaterClusterDeleteIrCmdCallback(uint16_t IRCommandID);
/** @brief IR Repeater Cluster Learn New Ir Cmd
 *
 * 
 *
 */
bool emberAfIrRepeaterClusterLearnNewIrCmdCallback(void);
/** @brief IR Repeater Cluster Server Attribute Changed
 *
 * Server Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 * @param attributeId Attribute that changed  Ver.: always
 */
void emberAfIrRepeaterClusterServerAttributeChangedCallback(uint8_t endpoint,
                                                            EmberAfAttributeId attributeId);
/** @brief IR Repeater Cluster Server Default Response
 *
 * This function is called when the server receives the default response from
 * the client.
 *
 ...
 * @param status Status in default response  Ver.: always
 */
void emberAfIrRepeaterClusterServerDefaultResponseCallback(uint8_t endpoint,
                                                           uint8_t commandId,
                                                           EmberAfStatus status);
/** @brief IR Repeater Cluster Server Init
 *
 * Server Init
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 */
void emberAfIrRepeaterClusterServerInitCallback(uint8_t endpoint);
/** @brief IR Repeater Cluster Server Manufacturer Specific Attribute Changed
 *
 * Server Manufacturer Specific Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * Ver.: always
 */
void emberAfIrRepeaterClusterServerManufacturerSpecificAttributeChangedCallback(uint8_t endpoint,
                                                                                EmberAfAttributeId attributeId,
                                                                                uint16_t manufacturerCode);
/** @brief IR Repeater Cluster Server Message Sent
 *
 * Server Message Sent
 *
 * @param type The type of message sent  Ver.: always
 ...
 * @param status The status of the sent message  Ver.: always
 */
void emberAfIrRepeaterClusterServerMessageSentCallback(EmberOutgoingMessageType type,
                                                       uint16_t indexOrDestination,
                                                       EmberApsFrame *apsFrame,
                                                       uint16_t msgLen,
                                                       uint8_t *message,
                                                       EmberStatus status);
/** @brief IR Repeater Cluster Server Pre Attribute Changed
 *
 * Server Pre Attribute Changed
 *
 * @param endpoint Endpoint that is being initialized  Ver.: always
 ...
 * @param value Attribute value  Ver.: always
 */
EmberAfStatus emberAfIrRepeaterClusterServerPreAttributeChangedCallback(uint8_t endpoint,
                                                                        EmberAfAttributeId attributeId,
                                                                        EmberAfAttributeType attributeType,
                                                                        uint8_t size,
                                                                        uint8_t *value);
/** @brief IR Repeater Cluster Server Tick
 *
 * Server Tick
 *
 * @param endpoint Endpoint that is being served  Ver.: always
 */
void emberAfIrRepeaterClusterServerTickCallback(uint8_t endpoint);
/** @brief IR Repeater Cluster Stop Learn Ir Cmd
 *
 * 
 *
 */
bool emberAfIrRepeaterClusterStopLearnIrCmdCallback(void);
/** @brief IR Repeater Cluster Update Ir State
 *
 * 
 *
 * @param State   Ver.: always
 * @param IRCommandID   Ver.: always
 */
bool emberAfIrRepeaterClusterUpdateIrStateCallback(uint8_t State,
                                                      uint16_t IRCommandID);

/** @} END IR Repeater Cluster Callbacks */
