...
#ifndef __EMBER_AF_DEBUG_PRINTING__
#define __EMBER_AF_DEBUG_PRINTING__
...
// Printing macros for cluster: Lumi Device optional
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_LM_DEV_OPT)
#define emberAfLmDevOptPrint(...) emberAfPrint(EMBER_AF_PRINT_LM_DEV_OPT, __VA_ARGS__)
#define emberAfLmDevOptPrintln(...) emberAfPrintln(EMBER_AF_PRINT_LM_DEV_OPT,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfLmDevOptFlush()
#define emberAfLmDevOptDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_LM_DEV_OPT) ) { x; }
#define emberAfLmDevOptPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_LM_DEV_OPT, (buffer), (len), (withSpace))
#define emberAfLmDevOptPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_LM_DEV_OPT, (buffer))
#else
#define emberAfLmDevOptPrint(...)
#define emberAfLmDevOptPrintln(...)
#define emberAfLmDevOptFlush()
#define emberAfLmDevOptDebugExec(x)
#define emberAfLmDevOptPrintBuffer(buffer, len, withSpace)
#define emberAfLmDevOptPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_LM_DEV_OPT)


// Printing macros for cluster: IR Repeater
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_IR_REPEATER_CLUSTER)
#define emberAfIrRepeaterClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_IR_REPEATER_CLUSTER, __VA_ARGS__)
#define emberAfIrRepeaterClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_IR_REPEATER_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfIrRepeaterClusterFlush()
#define emberAfIrRepeaterClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_IR_REPEATER_CLUSTER) ) { x; }
#define emberAfIrRepeaterClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_IR_REPEATER_CLUSTER, (buffer), (len), (withSpace))
#define emberAfIrRepeaterClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_IR_REPEATER_CLUSTER, (buffer))
#else
#define emberAfIrRepeaterClusterPrint(...)
#define emberAfIrRepeaterClusterPrintln(...)
#define emberAfIrRepeaterClusterFlush()
#define emberAfIrRepeaterClusterDebugExec(x)
#define emberAfIrRepeaterClusterPrintBuffer(buffer, len, withSpace)
#define emberAfIrRepeaterClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_IR_REPEATER_CLUSTER)
...
#endif // __EMBER_AF_DEBUG_PRINTING__
